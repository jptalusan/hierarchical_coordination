"""Scale-up sweep on real Memphis OSM.

Runs monolithic vs hierarchical (K=3, K=5) across a fleet × intensity grid,
saves per-run metrics to a parquet file, and produces the headline figures.

Usage:
    uv run python scripts/scaleup_sweep.py
"""
...
OUT_DIR = REPO_ROOT / "outputs" / "scaleup"
FLEET_SIZES = [30, 60, 120, 240]
